...
fun day4a(): Int {
  return DAY_4_INPUT.count {
    val array = it.split(" ")
    array.toList().size == array.toSet().size
  }
}
...
fun day4b(): Int {
  return DAY_4_INPUT.count {
    val array = it.split(" ")
    val sortedArray = array.map { string -> string.toCharArray().sorted().joinToString("") }

    println(it)
    println(sortedArray.joinToString(" "))
    println("----------")

    array.size == sortedArray.toSet().size
  }
}