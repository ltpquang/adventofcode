/**
 * Created by Quang Le on 1/30/18.
 *
...
fun day5b(): Int {
  ...
  while (0 <= currentIndex && currentIndex < DAY_5_INPUT.size) {
    val newIndex = currentIndex + DAY_5_INPUT[currentIndex]
    DAY_5_INPUT[currentIndex] += if (DAY_5_INPUT[currentIndex] >= 3) -1 else 1
    currentIndex = newIndex
    ++step
  }
  return step
